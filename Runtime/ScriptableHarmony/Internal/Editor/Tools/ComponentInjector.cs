...
namespace NuiN.ScriptableHarmony.Editor
{
    internal class ComponentInjector : AssetModificationProcessor
    {
        ...
        static void InjectComponents(Component monoBehaviourInstance)
        {
            ...
            {
                if (field.GetValue(monoBehaviourInstance) != null || field.GetCustomAttribute<InjectComponentAttribute>() == null) continue;
            ...
            {
                if (property.GetValue(monoBehaviourInstance) != null ||  property.GetCustomAttribute<InjectComponentAttribute>() == null) continue;
